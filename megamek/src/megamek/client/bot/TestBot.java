    ...
    public MovePath calculateMoveTurn() {
        ...
        if (min.getLastStep() != null) {
            if (min.getCEntity().entity.canUnjamRAC()) {
                if ((min.getLastStepMovementType() == EntityMovementType.MOVE_WALK)
                    || (min.getLastStepMovementType() == EntityMovementType.MOVE_VTOL_WALK)
                    || (min.getLastStepMovementType() == EntityMovementType.MOVE_NONE)) {
